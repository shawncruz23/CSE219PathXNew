...
public class PathXConstants {
    ...
    public static final String LEVEL_8_XML = "L8CastleBlack.xml";
    public static final String LEVEL_9_XML = "L9CrastersKeep.xml";
    public static final String LEVEL_10_XML = "L10CastleBlack.xml";
    public static final String LEVEL_11_XML = "L1CrastersKeep.xml";
    public static final String LEVEL_12_XML = "L2CastleBlack.xml";
    public static final String LEVEL_13_XML = "L1CrastersKeep.xml";
    public static final String LEVEL_14_XML = "L2CastleBlack.xml";
    public static final String LEVEL_15_XML = "L1CrastersKeep.xml";
    public static final String LEVEL_16_XML = "L2CastleBlack.xml";
    public static final String LEVEL_17_XML = "L1CrastersKeep.xml";
    public static final String LEVEL_18_XML = "L2CastleBlack.xml";
    public static final String LEVEL_19_XML = "L1CrastersKeep.xml";
    public static final String LEVEL_20_XML = "L2CastleBlack.xml";
