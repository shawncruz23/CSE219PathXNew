 ...
 */
public class PathXFiles {
    
    // THIS DOEST THE ACTUAL FILE I/O
    PathX_XML_Level_IO levelIO;
     ...
     * edited.
     */
    public PathXFiles(PathXDataModel initModel)
    {
        // INIT THE FILE I/O COMPONENT
        levelIO = new PathX_XML_Level_IO(new File(LEVELS_PATH + PROPERTIES_SCHEMA_LEVEL_FILE_NAME));
